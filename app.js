(function () {
  ...
  var messages = {
    ...
    ja: {
      ...
      configuration: "運用構成", loading: "規則データを読み込み中…", source: "データソース", result: "出発プラン", live: "ライブ", altitude: "初期高度", departure: "出発周波数", runway: "滑走路", summary: "クリアランス概要", copy: "コピー", summaryPlaceholder: "構成を選択すると概要が表示されます。", defaultWarning: "現在の運用構成、調整要件、有効な SOP を必ず確認してください。", simulation: "シミュレーション意思決定支援専用", copied: "クリップボードにコピーしました", loadError: "規則データを読み込めません。start.bat から起動してください。", revised: "改訂", primaryHeading: "離陸方位 / 上昇", primaryInstruction: "離陸指示",
